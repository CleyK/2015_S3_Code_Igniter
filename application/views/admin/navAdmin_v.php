...
<nav class="top-bar" data-topbar role="navigation">
    ...
    <li class="has-dropdown">
      ...
      <ul class="dropdown"> 
        <li><a  href="<?php echo site_url('Commande_c/afficherCommandeATraiter');?>" > consulter et préparer les commandes</a></li>
        <li><a href="<?php echo site_url('Commande_c/afficherCommande');?>" >afficher/editer/supprimer des commandes</a></li>
      </ul>
    </li>
    ...
    <li class="has-dropdown">
     <a href="#">Gestion des clients</a> 
      <ul class="dropdown fixed"> 
        <li><a  href="<?php echo site_url('Admin_c/afficheUsers');?>" >afficher/editer/supprimer des clients</a></li>
