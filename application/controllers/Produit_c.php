...
//partie client
    ...
    public function afficherProduit(){
        ...
        $produit['produit']=$this->Produit_m->getAllProduits();
        $this->load->view('clients/table_produit_client_v', $produit);
        $this->load->view('foot_v');
    }
/*
    ...
    public function afficherUsers(){
        ///$this->load->view('admin/comptesUsers_v', $usersAccount);
    }
    public function afficherCommandes(){
        ...
        $this->load->view('head_v');
        $this->load->view('admin/navAdmin_v');
        $commande = $this->getAllCommands();
        $this->load->view('admin/commande_v', $commande);
        $this->load->views('foot_v');
    }
